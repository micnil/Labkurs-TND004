...
class BST_threaded
{
    ...
    * \return Reference to the ELEMENT storing the key. If the key is not in the tree then the program has undefined behaviour.
    *
    */
    ...
    * \return A BiIterator referring to the node storing the key, if the key is found. Otherwise, return this->end().
    *
    */
    ...
    */
    ...
    /** \brief Disabled assignmnet operator.
    *
    */
